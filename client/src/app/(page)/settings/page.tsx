...
export default function SettingsPage() {
  ...
  if (loading) {
    return (
      <div className={isDarkMode ? 'kg-night-mode dark min-h-screen' : 'min-h-screen'}>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="flex items-start justify-between gap-4 rounded-md border border-gray-200 p-4">
              <div className="space-y-1">
                ...
                <p className="text-xs text-gray-600">
                  Apply dark surfaces and light text across the main app pages and domain graph views.
                </p>
              </div>
