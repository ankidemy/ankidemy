...
func main() {
	...
	graphHandler := handlers.NewGraphHandler(graphDAO, domainDAO, permissionDAO, sourceDAO, questDAO)
	...
	questHandler := handlers.NewQuestHandler(questDAO, domainDAO, permissionDAO, codeRegistryDAO, relationDAO, surveyService)
	relationHandler := handlers.NewRelationHandler(relationDAO, domainDAO, permissionDAO, metaDefinitionDAO, metaExerciseDAO, sourceDAO, questDAO)
	surveyHandler := handlers.NewSurveyHandler(domainDAO, permissionDAO, questDAO, surveyService)
